...
from gestures.gesture_disgust import disgust_gesture, disgust_audio
from older.breathing import breathing_gesture_head, breathing_gesture_wrist, breathing_gesture_lift, breathing_gesture_base
...
try:
    ...
    p7 = Process(target=breathing_gesture_head, args=(robot, 0))
