...
if(bpm == 60): filename = "../audios/drum_60.wav"
...
def dance1(robot):
    ...
    robot.end_of_arm.move_by('wrist_yaw',xwrist,Vrwrist,Arwrist)
    robot.base.rotate_by(-0.2, Vmrotation, amrotation)
    robot.push_command()
    # time.sleep(t3)
...
if __name__ == "__main__":
    ...
    p3.start()
    time.sleep(t3)
    p4 = Process(target=dance1(robot))
    p4.start()
    time.sleep(t3)
    p5 = Process(target=dance2(robot))
    p5.start()
    time.sleep(t3)
    p6 = Process(target=dance1(robot))
    p6.start()
    time.sleep(t3)
    p7 = Process(target=dance2(robot))
    p7.start()
    time.sleep(t3)
    p8 = Process(target=dance1(robot))
    p8.start()
    time.sleep(t3)
    p26 = Process(target=dance2(robot))
    p26.start()
    time.sleep(t3)
    p9 = Process(target=dance1(robot))
    p9.start()
    time.sleep(t3)
    p10 = Process(target=dance2(robot))
    p10.start()
    time.sleep(t3)
    p11 = Process(target=dance1(robot))
    p11.start()
    time.sleep(t3)
    p12 = Process(target=dance2(robot))
    p12.start()
    time.sleep(t3)
    p13 = Process(target=dance1(robot))
    p13.start()
    time.sleep(t3)
    p14 = Process(target=dance2(robot))
    p14.start()
    time.sleep(t3)
